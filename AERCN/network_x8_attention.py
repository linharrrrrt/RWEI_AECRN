...
class Network_x8_attention(nn.Module):
	'''
	...
	def __init__(self, mean, tiny):
		...
		Constructor.
		'''
		super(Network_x8_attention, self).__init__()

		self.conv1 = nn.Conv2d(1, 32, 3, 1, 1)
		self.conv2 = nn.Conv2d(32, 64, 3, 2, 1)
		self.conv3 = nn.Conv2d(64, 128, 3, 2, 1)
		# self.conv3 = nn.Conv2d(64, 128, 3, 1, 1)
		self.cbam1 = attention(gate_channels=128,reduction_ratio=16)
		self.conv4 = nn.Conv2d(128, (256,128)[tiny], 3, 2, 1)
		self.cbam2 = attention(gate_channels=(256,128)[tiny],reduction_ratio=16)
